...
const buttonField = createMuiTheme({ 
    palette: { 
        primary: {
            main:'#ffb100',
        },
...
class client_information extends Component {
    ...
    console.log('industry', list_industries)
    let new_industry=list_industries.filter(option=>{return option.value===industry})
        return (
            <div>
                <MuiThemeProvider theme={themeField}>
                    ...
                    <div style={{width:425,marginBottom:15}}>
                    {/* <AutoCompleteSelect
                        onChange={(event,value)=>this.props.setIndustry(value.value)}
                    ...
                    <Select 
                        ...
                        placeholder={<>Industry<span style={{color:'red'}}>*</span></>}
                        styles={{
