                ...
                <div className='detail-card-header'>
                    ...
                    <div style={{display:'flex'}}>
                        <MuiThemeProvider theme={themeButton2}>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp; */}
                            {pipeline.detail_deal.state.text!=='Lost'&&<img onClick={()=>pipeline.detail_deal.proposal!==null?editProposal(pipeline.detail_deal.proposal):null} src={Edit} className='card-header-icon' />}
                        </MuiThemeProvider>
                    </div>
                </div>
