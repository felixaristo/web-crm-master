        ...
        <div className='jurnal-item-proposal'>
            ...
            <div className='card-content-item-jurnal'>
                <div style={{display:'flex',justifyContent:'space-between',alignItems:'center'}}>
                    <p className='card-content-item-jurnal-text'>Proposal file &nbsp;&nbsp;&nbsp;{props.data.data.info.filename!==null&&props.data.data.info.filename.length>35?`${props.data.data.info.filename.substring(0,35)}...`:props.data.data.info.filename}</p>
                    <MuiThemeProvider theme={themeButton2}>
                        <Button onClick={onClickView} size='small' variant='text' color='secondary' className='btn-remove-capital' style={{fontWeight:'bold'}}>View</Button>
                    </MuiThemeProvider>
    ...
    return(
        <div className='jurnal-item-proposal'>
            <div className='card-header-item-jurnal'>
                ...
                <p className='card-header-item-jurnal-subtitle'>{moment(data.data.data.info.fromTime).format('DD MMM YYYY | HH:mm')}&nbsp;&nbsp;<img src={Edit} style={{width:15,cursor:'pointer'}} onClick={()=>editSalesVisit(data.data.data.info)}/></p>
            </div>
            <div className='card-content-item-jurnal'>
        ...
        let map=history.map((data,i)=>{
            if(data.type==='prop'){
                return(
                    <div className='jurnal-item'>
                        <div className='jurnal-item-content'>
                            <ProposalCard data={data} profile={props.profile} token={props.token}/>
                        </div>
                    </div>
                )
                ...
                return(
                    <div className='jurnal-item'>
                        <div className='jurnal-item-content'>
                            <SalesMeeting data={data} editSalesVisit={editSalesVisit}/>
                        </div>
                    </div>
                )
                ...
                return(
                    <div className='jurnal-item'>
                        <div className='jurnal-item-content'>
                            <Probability data={data} editSalesVisit={editSalesVisit}/>
                        </div>
                    </div>
                )
                ...
                return(
                    <div className='jurnal-item'>
                        <div className='jurnal-item-content'>
                            <PricingCard data={data}  data={data} profile={props.profile} token={props.token}/>
                        </div>
                    </div>
                )
                ...
                return(
                    <div className='jurnal-item'>
                        <div className='jurnal-item-content'>
                            <ToBeamount data={data}  data={data} profile={props.profile} token={props.token}/>
                        </div>
                    </div>
                )
                ...
                return(
                    <div className='jurnal-item'>
                        <div className='jurnal-item-content'>
                            <ToBe data={data}  data={data} profile={props.profile} token={props.token}/>
                        </div>
                    </div>
                )
                ...
                return(
                    <div className='jurnal-item'>
                        <div className='jurnal-item-content'>
                            <Invoiced data={data}  data={data} profile={props.profile} token={props.token}/>
                        </div>
                    </div>
                )
                ...
                return(
                    <div className='jurnal-item'>
                        <div className='jurnal-item-content'>
                            <ToBeDate data={data}  data={data} profile={props.profile} token={props.token}/>
                        </div>
                    </div>
                )
            }
