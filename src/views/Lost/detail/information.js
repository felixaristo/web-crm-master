...
export default function Information(props) {
    ...
    useEffect(()=>{
        if(pipeline.detail_deal!==null){
            const {clientCompany,clientContact,clientMembers,id}=pipeline.detail_deal
    ...
    const onClickSave=()=>{
        ...
        dispatch(updateClient2(props.token,data))
        setEdit(false)
    ...
    console.log('state.clientMembers', master)
    return (
        <div>
                ...
                <div className='detail-card-header'>
                    ...
                    <div style={{display:'flex'}}>
                        <MuiThemeProvider theme={themeButton2}>
                            ...
                            <>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            {pipeline.detail_deal.state.text!=='Lost'&&<img onClick={()=>setEdit(true)} src={Edit} className='card-header-icon' />}
                            </>
                            }
                        </MuiThemeProvider>
                    </div>
