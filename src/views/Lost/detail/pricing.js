           ...
           <div className='detail-card-wrapper'>
                ...
                :
                    <div style={{textAlign:'center'}}>
                        {pipeline.detail_deal.state.text!=='Lost'&&<Button component='label' size='small' color='primary' variant='contained' className='head-add-section__btn remove-boxshadow' style={{width:180}}>
                            Upload Pricing
                            <input
                                type="file"
                                style={{ display: "none" }}
