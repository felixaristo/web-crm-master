...
export default function Detail(props) {
    ...
    const {id,name,clientCompany,clientContact,probability,age,stages}=pipeline.detail_deal
    ...
    const backdropToggle=()=>{
     ...
     console.log('master.tab_back', master.tab_back)
    return (
        <div>
            ...
            <div onClick={backdropToggle} style={{zIndex:2,width:'100%',height:700,position:'absolute',top:0,left:0,display:backdrop?'block':'none'}}></div>
                ...
                <p className='header-title'>{name}&nbsp; <img onClick={()=>modalsToggle('name')} src={Edit} className='icon-action'/></p>
                <div className='header-menu'>
                    <div className='header-data'>
                        ...
                        <div className='div-flex' style={{cursor:'pointer'}} onClick={()=>modalsToggle('probability')}>
                    ...
                    <div className='header-btn'>
                            ...
                            <Button onClick={()=>reopenDeal(id)} size='small' color='secondary' variant='contained' className='head-add-section__btn remove-boxshadow' >Reopen</Button>
                        </MuiThemeProvider>
                            :
                            <>
                            <MuiThemeProvider theme={themeButton2}>
                            ...
                            {pipeline.detail_deal.state.text!=='Won'&&
                            <>
                            ...
                            <Button onClick={()=>deleteDeal(id)} size='small' color='secondary' variant='text' className='head-add-section__btn remove-boxshadow' style={{backgroundColor:'#eeeeee'}}>Delete</Button>
            ...
            <div className='detail-content'>
                <div className='detail-card'>
                    ...
                    <Owners detailEmployee={detailEmployee}/>
