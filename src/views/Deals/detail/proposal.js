...
export default function Proposal(props) {
    ...
    const addProposal=(clientId,dealId)=>{
           ...
           <div className='detail-card-wrapper'>
                <div className='detail-card-header'>
                    ...
                    <div style={{display:'flex'}}>
                        <MuiThemeProvider theme={themeButton2}>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp; */}
                            {pipeline.detail_deal.state.text!=='Lost'&&handle_access(props.profile.id,props.profile.roleId,[],new_rms_for_access)&&<img onClick={()=>pipeline.detail_deal.proposal!==null?editProposal(pipeline.detail_deal.proposal):addProposal(pipeline.detail_deal.clientId,pipeline.detail_deal.id)} src={Edit} className='card-header-icon' />}
                        </MuiThemeProvider>
                    </div>
                </div>
                <div className='detail-card-body'>
                    ...
                    <div style={{display:'flex',justifyContent:'space-between'}}>
                        ...
                        <MuiThemeProvider theme={themeButton2}>
                            {pipeline.detail_deal.proposal!==null&&pipeline.detail_deal.proposal.filename!==""&&
