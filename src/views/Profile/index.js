...
export default function Index(props) {
    ...
    useEffect(() => {
        dispatch(actionRm.getDetailRm(props.profile.id))
    ...
    console.log(`detail_rm`, detail_rm)
    return (
        <div>
            <Layout>
            ...
            <div className='head-section'>
                ...
                <Button onClick={onClickSave} className='head-add-section__btn remove-boxshadow' variant='contained' color="secondary">{tab==='detail'?'Edit':'Save'}</Button>
                </div>
                    ...
                    <div style={{width:'50%'}}>
                        ...
                        <div className='div-flex div-align-center'>
                            ...
                            <Button disabled={handleDisable2()} component="label" style={{marginLeft:100}} onClick={null} className='btn-remove-capital btn-rounded' variant='contained' color="secondary">
                                {detail_rm.file_url!==''?'Edit Photo':'Add Photo'}
                                <input
                                    type="file"
                                    style={{display:'none'}}
